...
+   Download a copy of the slides from the Orientation
    from:[JHPCE-Overview-CMS.pdf.](http://ec2-44-214-193-38.compute-1.amazonaws.com/wp-content/uploads/2024/01/JHPCE-Overview-CMS-2023-12.pdf)
+   
...
1.  **Install the 2 Factor Authentication program.**  The JHPCE cluster
    ...
    see <http://ec2-44-214-193-38.compute-1.amazonaws.com/knowledge-base/authentication/2-factor-authentication/#otp>
    for instructions.
