...
Policies and Practices", with a ++greater-than++ to the right of it. You will see two
...
Clicking on the ++greater-than++ symbol will reveal a submenu, which contains pages related to backups and restores, managing allocation access, disk quotas, etc.
